  ...
  <body>
    ...
    <script>
        ...
        $("#emailform").submit(function(event){
            ...
            $("#alerts").html('<div class="alert alert-success" role="alert">Email queued. You can close this page, or you way wait for confirmation that your email went through.</div>');

            // Callback handler that will be called on success
            request.done(function (response, textStatus, jqXHR){
                $("#alerts").html('<div class="alert alert-success" role="alert">Email sent successfully.</div>');
