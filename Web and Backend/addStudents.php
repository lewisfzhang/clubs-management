...
<!--         <div class="row" style="padding-bottom:10px">
          ...
          <div class="alert alert-warning">
            <strong>For Safari Users:</strong> We just resolved an issue with this page in Safari. If you previously tried adding members to your club using this page, please double check to make sure they’re on your roster. If not, please re-add them here.
          </div>
